...
public class FileSystemTests {
  ...
  private final ImplementationCLI cli = new ImplementationCLI();
  private final FileSystemRunner runner = new CLIRunner(cli);
  ...
  void test3() {
    executeTest(
        List.of(
            ...
            // ESTE TEST ESTA MAL EL COMANDO RM SIN ARGUMENTOS DEBE DAR ERROR
  ...
  void test7() {
    executeTest(
        List.of(
            ...
            entry(
                "ls",
                "emily.txt jetta.txt"), // Aca quiere que el listado sea en orden de mas viejo a mas
            // nuevo
  ...
  void test8() {
    executeTest(
        List.of(
            ...
            entry("touch jetta.txt", "'jetta.txt' file created"),
            // entry("ls", "emily emily.txt jetta.txt"), //ESTA MAL: emily.txt nunca se crea
            entry("rm --recursive emily", "'emily' removed"),
            // entry("ls", "emily.txt jetta.txt"), //ESTA MAL: emily.txt nunca se crea
            // entry("ls --ord=desc", "jetta.txt emily.txt"), //ESTA MAL: emily.txt nunca se crea
